...
void DashboardPage::loadRealData()
{
    ...
    // 请求自选股数据
        ...
        // 使用 DataHub 统一调度（数据源内部自动获取 DataHub 实例）
        d->indexDataSource->registerToDataHub(5000);
        d->rankDataSource->registerToDataHub(5000);
        d->watchlistDataSource->registerToDataHub(5000);
